...
exports.updateExternalCalls = exports.updateErrors = exports.updateProviderHits = exports.updateHits = void 0;
...
const keyService = (0, createKey_1.createKeyService)({
...
function updateErrors(request) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, updateStats_1.updateErrorStats)(request, writeRepository, keyService);
    });
}
exports.updateErrors = updateErrors;
function updateExternalCalls(request) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield (0, updateStats_1.updateExternalAPIUsageStats)(request, writeRepository, keyService);
    });
}
exports.updateExternalCalls = updateExternalCalls;
